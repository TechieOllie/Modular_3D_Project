...
bool kinematics_home_axis(char axis)
{
    ...
    if (axis == 'X' || axis == 'x')
    {
        if (!stepper_motor_home_precision(machine_config.x_motor_id, 2000, 400)(machine_config.x_motor_id, 1000);)
        {
    ...
    {
        if (!stepper_motor_home_precision(machine_config.x_motor_id, 2000, 400)(machine_config.y_motor_id, 1000);)
        {
